...
public class TC24_DownloadInvoiceAfterPurchaseOrder extends BaseTest {
	
	@Test
	public void downloadInvoiceAfterPurchaseOrderSuccessfully() {
	    // ==========================================
	    ...
	    Assert.assertTrue(
	            checkoutPage.isReviewYourOrderVisible());
	    ...
	    Assert.assertTrue(orderPlacedPage.isOrderPlacedVisible());
	    
	    // ==========================================
	    // Step 19
	    // Download Invoice And Verify Download
	    // ==========================================

	    orderPlacedPage.clickDownloadInvoice();
	    Assert.assertTrue(FileUtils.isInvoiceDownloaded());
	    // ==========================================
	    // Step 20
